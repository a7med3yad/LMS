...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Domain.Models.AssignmentSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LMS.Domain.Models.Exam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LMS.Domain.Models.ExamAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LMS.Domain.Models.ExamAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LMS.Domain.Models.Material", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LMS.Domain.Models.QuestionChoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LMS.Domain.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Domain.Models.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LMS.Domain.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("LMS.Domain.Models.Voucher", "Voucher")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("LMS.Domain.Models.ExamAnswer", b =>
                {
                    b.HasOne("LMS.Domain.Models.ExamAttempt", "Attempt")
                        .WithMany("Answers")
                    ...
                    b.HasOne("LMS.Domain.Models.QuestionChoice", "SelectedChoice")
                        .WithMany()
            ...
            modelBuilder.Entity("LMS.Domain.Models.ExamAttempt", b =>
                {
                    b.HasOne("LMS.Domain.Models.Exam", "Exam")
                        .WithMany("Attempts")
            ...
            modelBuilder.Entity("LMS.Domain.Models.Notification", b =>
                {
                    b.HasOne("LMS.Domain.Models.ApplicationUser", "User")
